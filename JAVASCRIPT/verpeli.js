    ...
    (localSTGPeliEs) =>
      `
           <div class="row d-flex align-items-center justify-content-center mt-2 ">
            <img src="${localSTGPeliEs.imgPeli}" class="mt-2 img-fluid foto-verpeli" alt="${localSTGPeliEs.nombrePeli}">
             </div>
            ...
            <div class="m-2 col">
                   ...
                   <div ><p >${localSTGPeliEs.duraPeli} min &nbsp&nbsp&nbsp&nbsp&nbsp    +16  &nbsp&nbsp&nbsp&nbsp&nbsp    ⭐⭐⭐⭐⭐</p>
                        ...
                        <button type="button" class="btn violeta-claro m-2 text-light "><a class="text-decoration-none text-white" href="error 404.html"><i class="fa-solid fa-play mx-2"></i>Reproducir</a></button>
